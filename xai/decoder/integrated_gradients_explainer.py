"""Integrated-Gradients explainability — standalone CLI entry point."""
...
from engine.ig_attribution import IG_BASELINE_MODES, IGAttribution
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--ig-baseline", choices=IG_BASELINE_MODES, default="mean-fill")
    ...
    # Shared XAI args kept for CLI parity with action_explainer and consumed by the engine.
...
def run(args: argparse.Namespace) -> Path:
    """Run IG attribution and return the saved report path."""
    ...
    attribution = IGAttribution(ig_steps=int(args.ig_steps), ig_baseline=str(args.ig_baseline))

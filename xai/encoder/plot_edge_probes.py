...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--input-json", default="logs/xai/encoder/edge/probes/comparison.json")
    parser.add_argument("--output-dir", default="logs/xai/encoder/edge/probes/plots")
    parser.add_argument(
        "--projection-methods",
        nargs="*",
        choices=["pca", "tsne"],

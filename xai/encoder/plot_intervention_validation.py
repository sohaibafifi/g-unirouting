...
def _write_readme(output_dir: Path, generated: Sequence[Path]) -> Path:
    lines = [
        ...
        "",
        "- `intervention_concept_success_heatmap.png`: did the intervention move the target concept as intended?",
        "- `intervention_pca_directional_success_heatmap.png`: did the selected PCA component move in the expected direction?",
        "- `intervention_ica_directional_success_heatmap.png`: same question for ICA",
        "- `intervention_summary_bars.png`: aggregate comparison of concept success and latent directional success",
        "",
        "Generated files:",
    ]
